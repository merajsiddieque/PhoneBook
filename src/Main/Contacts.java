...
//            Class.forName("com.mysql.jdbc.Driver");
           ...
           String query = "SELECT CONCAT(first_name, ' ', last_name) AS full_name, phone_no,gmail,company FROM Contacts where blocked=false and username=?";
    ...
    private void initComponents() {
        ...
        jLabelAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/addicon.png"))); // NOI18N
        ...
        jLabelUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/updateicon.png"))); // NOI18N
        ...
        jLabelBlock.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Blockicon.png"))); // NOI18N
        jLabelBlock.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelBlockMouseClicked(evt);
            }
        });
        ...
        jPanelSearchLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSearchLayout.createSequentialGroup()
                .addGap(46, 46, 46)
                .addComponent(jLabelAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanelSearchLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSearchLayout.createSequentialGroup()
                ...
                .addGroup(jPanelSearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelSearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//            Class.forName("com.mysql.jdbc.Driver");
           ...
           java.sql.Connection con = DriverManager.getConnection(db,"root","root");
           String query = "SELECT CONCAT(first_name, ' ', last_name) AS full_name, phone_no, gmail, company FROM Contacts WHERE username = ?  and CONCAT(first_name, ' ', last_name) LIKE ? ";
    ...
    private void jLabelUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelUpdateMouseClicked
        ...
        if(selectedRow == -1){
            ...
            String data[] = fullName.split(" ",2);
            String firstName = data[0];
            String lastName = data[1];
            String phoneNo = tblModel.getValueAt(jTable1.getSelectedRow(), 2).toString();
            String gMail = tblModel.getValueAt(jTable1.getSelectedRow(), 3).toString();
            String company = tblModel.getValueAt(jTable1.getSelectedRow(), 4).toString();
            new Update(user,firstName,lastName,phoneNo,gMail,company).setVisible(true);
        }
    ...
    private void jLabelDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelDeleteMouseClicked
        ...
        if(selectedRow == -1){
           ...
           try{
               ...
               String query = "delete from contacts where phone_no =? and username =?;";
    ...
    private void jLabelBlockMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBlockMouseClicked
        // TODO add your handling code here:
       DefaultTableModel tblModel = (DefaultTableModel)jTable1.getModel();
        int selectedRow = jTable1.getSelectedRow();
        if(selectedRow == -1){
       ...
       try
       {
           ...
           int rows = pstmt.executeUpdate();
           if(rows > 0){
               JOptionPane.showMessageDialog(this,"Blocked Successfully !");
           }
           else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                String user = null;
                new Blocked("mihir").setVisible(true);
            }
        });
    }
